...
<body>
    <h3 class="text-center" id="merienda">Daftar Piutang</h3>
    <table class='table table-bordered' style="width: 60%; margin-top: 2%; margin-left: 20%">
        ...
        <a href="<?php echo site_url('Piutang'); ?>" role="button" class="btn btn-danger"><i class="fas fa-arrow-circle-left"></i> Kembali</a>
    </div>
</body>
</html>